  ...
  template: `
    ...
    >
      ...
      <div class="flex items-center gap-2 md:gap-4">
        ...
        <button
          (click)="toggleTheme()"
          class="p-2 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-fast flex justify-center items-center cursor-pointer"
        ...
        <!-- User -->
        <div class="flex items-center gap-3 sm:flex">
        ...
        <button
          (click)="onLogout()"
          class="p-2 text-slate-500 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 rounded-full transition-fast flex justify-center items-center cursor-pointer"
